...
This script shows how to map results from the model output to a previously contructed phylogenetic tree. For this visualisation, the ggtree package is called. The *ggplot2*
